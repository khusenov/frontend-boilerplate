...
> **Status:** Complete · **Layers:** app, pages, features, entities, shared, outside layers · **Verified against:** `5c55de1`
...
`observability`, `testing`, `theme`, `ui` in `shared`). That `api` segment offers five things, three of them _ports_. A
