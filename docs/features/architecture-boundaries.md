...
| Segment barrels                                                                                                                                              | `shared`                        | One public API per segment: `api`, `config`, `i18n`, `observability`, `testing`                                                                                                                          | `src/shared/*/index.ts`                                                      |
...
| `fsd/ambiguous-slice-names`        | A slice named like a `shared` segment — here `api`, `config`, `i18n`, `lib`, `observability`, `testing` or `ui`                                                                                                                                                                                                                                                                                                                      |
